                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="socials text-center">
                            ...
                            <div class="addthis_inline_share_toolbox_8xv0"></div>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-content">
                            <div class="author-info">
                                ...
                                <p class="author-info">Computer Engineer</p>
                            </div>
                            ...
                            <div class="socials">
                                ...
                                <a href="{{$post->user->profile->facebook}}" class="social__item" target="_blank">
                                    <img src="{{asset('theme/app/svg/circle-facebook.svg')}}" alt="facebook">
                                </a>

                                <a href="{{$post->user->profile->youtube}}" class="social__item" target="_blank">
                                    <img src="{{asset('theme/app/svg/youtube.svg')}}" alt="youtube">
                                </a>
